            ...
            <div
              ...
              <dl class="mb-0 text-justify">
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0 d-flex align-items-center justify-content-between">
                  Terlewat <span class="badge bg-danger rounded-pill ms-2"> {{ $dokumen->terlewat }}</span>
                </dd>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0 d-flex align-items-center justify-content-between">
                  Telat <span class="badge bg-warning rounded-pill ms-2"> {{ $dokumen->telat }}</span>
                </dd>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0 d-flex align-items-center justify-content-between">
                  Terkumpul <span class="badge bg-success rounded-pill ms-2"> {{ $dokumen->terkumpul }}</span>
                </dd>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0 d-flex align-items-center justify-content-between">
                  Ditugaskan <span class="badge bg-info rounded-pill ms-2"> {{ $dokumen->ditugaskan }}</span>
                </dd>
              </dl>
