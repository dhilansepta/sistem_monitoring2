...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Tambah User Baru</h1>
...
<div class="content">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Form Tambah User</h3>
        </div>
        <div class="block-content block-content-full">
            <form method="POST" action="{{ route('gkmf.store-user') }}">
                @csrf
                    ...
                    <div class="col-lg-8 col-xl-5 offset-lg-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('role') is-invalid @enderror" 
                                ...
                                <option value="gkmp" {{ old('role') == 'gkmp' ? 'selected' : '' }}>GKMP</option>
                            </select>
                            @error('role')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-alt-primary">
                                <i class="si si-save me-1"></i> Simpan
                            </button>
                        </div>
                    </div>
                </div>
