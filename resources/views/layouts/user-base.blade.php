          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              @elseif(Auth()->user()->role == 'gkmf')
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link {{ Request::is('gkmf/penugasan') ? 'active' : '' }}" href="{{ route('gkmf.penugasan.step-one') }}">
        ...
        <div class="content py-3">
          <div class="row fs-sm">
            <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
              <a class="fw-semibold" href="#">Program Studi Teknik Informatika ITERA</a> &copy; <span data-toggle="year-copy"></span>
            </div>
          </div>
        </div>
      </footer>
